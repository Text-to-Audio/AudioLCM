...
class DiffusionWrapper(pl.LightningModule):
    def __init__(self, diff_model_config, conditioning_key):
        ...
        assert self.conditioning_key in [None, 'concat', 'crossattn', 'hybrid', 'adm','film']

    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None,c_film: list = None, w_cond=None):
        x = x.contiguous()
        t = t.contiguous()
        ...
        if self.conditioning_key is None:
            ...
            if w_cond is not None:
                out = self.diffusion_model(x, t, context=cc, w_cond=w_cond)
            else:
