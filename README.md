...
PyTorch Implementation of [EchoAudio]: Efficient and High-Quality Text-to-Audio Generation with Minimal Inference Steps.
...
We will provide our pretrained models in Huggingface as open source in this repository after accpeted.

Visit our [demo page](https://echo-audio.github.io/) for audio samples.
...
```bash
python scripts/txt2audio_for_lcm.py  --ddim_steps 2 -b configs/echoaudio.yaml --sample_rate 16000 --vocoder-ckpt  vocoder/logs/bigvnat16k93.5w --outdir results --test-dataset audiocaps  -r ckpt/echoaudio.ckpt
```
# Train
## dataset preparation
